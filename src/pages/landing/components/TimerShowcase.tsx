...
export default function TimerShowcase() {
  return (
    <section className="py-12 border-t border-cdc-border">
      <div className="max-w-[1180px] mx-auto px-[18px] md:px-6 grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-10 lg:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-forest-100 to-forest-50 rounded-3xl blur-2xl opacity-50" />
            <img
              src={timerAppPng}
              alt="ATTENDX time management"
        ...
        <div>
          ...
          <p className="text-[13px] text-muted leading-[1.7] mb-6">From setting schedules to tracking project milestones — ATTENDX gives you the tools to coordinate your entire workforce from a single, streamlined hub.</p>
